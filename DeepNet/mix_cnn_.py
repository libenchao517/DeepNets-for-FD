...
class MIX_CNN:
    """
    Zhao Z, Jiao Y.
    A fault diagnosis method for rotating machinery based on CNN with mixed information [J].
     IEEE Transactions on Industrial Informatics, 2022, 19(8): 9091-9101.
